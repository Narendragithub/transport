...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <form class="form-horizontal" method="post" action="/vehicle/updateservicing"> 
    {!! csrf_field() !!}
     <input type="hidden" name="id" value="{{$servicing->id}}">
            ...
            <!-- <form class="form-horizontal"> -->
              <div class="box-body">
                  ...
                  <div class="col-sm-8">
                    <select class="form-control" id="inputvehicleno" name="vehicleno">
                      <option value="">Vehicle No.</option>
                        ...
                        <option value="{{ $vehicle->id }}"  <?php if($vehicle->id==$servicing->vehicleno){ echo "selected='selected'";} ?>>{{ $vehicle->vehiclename.'-('.$vehicle->vehicleno.')' }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group @if ($errors->has('autopart_name')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputautopart_name" placeholder="Autoparts Name" name="autopart_name" value="{{ $servicing->autopart_name }}">
                ...
                <div class="form-group @if ($errors->has('autopart_contactno')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputautopart_contactno" placeholder="Autoparts Contactno." name="autopart_contactno" value="{{ $servicing->autopart_contactno }}">
                ...
                <div class="form-group @if ($errors->has('city')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputautopart_city" placeholder="Autoparts City" name="city" value="{{ $servicing->city }}">
                 ...
                 <div class="form-group @if ($errors->has('oil_change')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <select class="form-control" id="inputoil_change" name="oil_change">
                      <option value="no" <?php if($servicing->oil_change=='no'){ echo "selected='selected'";} ?>>No</option>
                      <option value="yes" <?php if($servicing->oil_change=='yes'){ echo "selected='selected'";} ?>>Yes</option>
                    </select>
                ...
                <div class="form-group @if ($errors->has('oil_amount')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputoil_amount" placeholder="Oil Amount" name="oil_amount" value="{{ $servicing->oil_amount }}">
                ...
                <div class="form-group @if ($errors->has('change_parts_name')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputchange_parts_name" placeholder="Change Parts Name" name="change_parts_name" value="{{ $servicing->change_parts_name }}">
                ...
                <div class="form-group @if ($errors->has('parts_amount')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputparts_amount" placeholder="Change Parts Amount" name="parts_amount" value="{{ $servicing->parts_amount }}">
                ...
                <div class="form-group @if ($errors->has('bill_no')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputbill_no" placeholder="Bill no./Receipt no." name="bill_no" value="{{ $servicing->bill_no }}">
                ...
                <div class="form-group @if ($errors->has('bill_amount')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputbill_amount" placeholder="Bill Total Amount" name="bill_amount" value="{{ $servicing->bill_amount }}">
                ...
                <div class="form-group @if ($errors->has('paid_amount')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputpaid_amount" placeholder="Paid Amount" name="paid_amount" value="{{ $servicing->paid_amount }}">
                 ...
                 <div class="form-group @if ($errors->has('remaining_amount')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputremaining_amount" placeholder="Remaining Amount" name="remaining_amount" value="{{ $servicing->remaining_amount }}">
                ...
                <div class="form-group date @if ($errors->has('servicing_date')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control datepicker" id="inputservicing_date" placeholder="Servicing Date" name="servicing_date" value="{{ $servicing->servicing_date }}">
