...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <form class="form-horizontal" method="post" action="/vehicle/update"> 
    {!! csrf_field() !!}
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              <div class="box-body">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputVehiclename" placeholder="Vehicle Name (Gaadi ka naam)" name="vehiclename" value="{{$vehicle->vehiclename}}">
                ...
                <div class="form-group @if ($errors->has('vehicleno')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputVehicleno" placeholder="Vehicle Number (Gaadi no.)" name="vehicleno" value="{{ $vehicle->vehicleno }}">
                ...
                <div class="form-group @if ($errors->has('vcompanyname')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputCompanyName" placeholder="Company Name" name="vcompanyname" value="{{ $vehicle->companyno }}">
                ...
                <div class="form-group @if ($errors->has('vcompanycode')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputCompanyCode" placeholder="Company Code" name="vcompanycode" value="{{ $vehicle->companycode }}">
                ...
                <div class="form-group @if ($errors->has('modelno')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputModelno" placeholder="Model Number" name="modelno" value="{{ $vehicle->modelno }}">
                ...
                <div class="form-group @if ($errors->has('engineno')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputEngineno" placeholder="Engine Number" name="engineno" value="{{ $vehicle->engineno }}">
                ...
                <div class="form-group @if ($errors->has('chasisno')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputChasisno" placeholder="Chasis Number" name="chasisno" value="{{ $vehicle->chasisno }}">
                ...
                <div class="form-group @if ($errors->has('permittype')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputPermittype" placeholder="Permit Type" name="permittype" value="{{ $vehicle->permittype }}">
            ...
            <!-- <form class="form-horizontal"> -->
              <div class="box-body">
                <div class="form-group @if ($errors->has('fin_companyname')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputFinComapnyname" placeholder="Finance Company Name" name="fin_companyname" value="{{ $vehicle->fin_companyname }}">
                ...
                <div class="form-group @if ($errors->has('fin_companycode')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputFinComapnycode" placeholder="Finance Company Code" name="fin_companycode" value="{{ $vehicle->fin_companycode }}">
                ...
                <div class="form-group @if ($errors->has('fin_accountno')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputFinAccountno" placeholder="Finance Account no." name="fin_accountno" value="{{ $vehicle->fin_accountno }}">
                ...
                <div class="form-group @if ($errors->has('premium_type')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <!-- <input type="text" class="form-control" id="inputPremiumtype" placeholder="Premium Type" name="premium_type" value="{{ $vehicle->premium_type }}"> -->
                    <select class="form-control" id="inputPremiumtype" name="premium_type" onchange="">
                      <option value="">Select Type</option>
                      <option value="Monthly" <?php if($vehicle->fin_premiumtype=='Monthly'){echo "selected='selected'";} ?>>Monthly</option>  
                      <option value="Quaterly" <?php if($vehicle->fin_premiumtype=='Quaterly'){echo "selected='selected'";} ?>>Quaterly (3 month)</option> 
                      <option value="Halfyearly" <?php if($vehicle->fin_premiumtype=='Halfyearly'){echo "selected='selected'";} ?>>Halfyearly (6 month)</option> 
                      <option value="Yearly" <?php if($vehicle->fin_premiumtype=='Yearly'){echo "selected='selected'";} ?>>Yearly (1 Yearly)</option> 
                    </select>
                ...
                <div class="form-group @if ($errors->has('premium_amount')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputPremiumamount" placeholder="Premium Amount" name="premium_amount" value="{{ $vehicle->fin_premiumamount }}">
                ...
                <div class="form-group @if ($errors->has('premium_date')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputPremiumdate" placeholder="Premium Date" name="premium_date" value="{{ $vehicle->fin_premiumdate }}">
            ...
            <!-- <form class="form-horizontal"> -->
              <div class="box-body">
                <div class="form-group @if ($errors->has('inscompany_name')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputInsCompany" placeholder="Insurance Company Name" name="inscompany_name" value="{{ $vehicle->ins_companyname }}">
                ...
                <div class="form-group @if ($errors->has('inscompany_code')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputInsCompanycode" placeholder="Insurance Company Code" name="inscompany_code" value="{{ $vehicle->ins_companycode }}">
                ...
                <div class="form-group @if ($errors->has('ins_policyno')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputInsPolicyno" placeholder="Insurance Policy no." name="ins_policyno" value="{{ $vehicle->ins_policyno }}">
                ...
                <div class="form-group date @if ($errors->has('ins_date')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control datepicker pull-right" id="inputInsDate" placeholder="Insurance Date" name="ins_date" value="{{ $vehicle->ins_date }}">
                ...
                <div class="form-group @if ($errors->has('ins_expdate')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control datepicker pull-right" id="inputInsExpDate" placeholder="Insurance Expire Date" name="ins_expdate" value="{{ $vehicle->ins_expirdate }}">
                ...
                <div class="form-group @if ($errors->has('ins_agentname')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputAgentname" placeholder="Insurance Agent Name" name="ins_agentname" value="{{ $vehicle->ins_agentname }}">
                ...
                <div class="form-group @if ($errors->has('ins_agentphone')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputAgentno" placeholder="Insurance Agent Phone no." name="ins_agentphone" value="{{ $vehicle->ins_agentphone }}">
                ...
                <div class="form-group @if ($errors->has('ins_amount')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputAmount" placeholder="Insurance Amount" name="ins_amount" value="{{ $vehicle->ins_amount }}">
                ...
                <div class="form-group @if ($errors->has('ins_validat')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputValidat" placeholder="Insurance Validity time" name="ins_validat" value="{{ $vehicle->ins_validatat }}">
            ...
            <!-- <form class="form-horizontal"> -->
              <div class="box-body">
                <div class="form-group @if ($errors->has('driverid')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                  	<select class="form-control" id="inputDriverid" name="driverid" onchange="getDriverDetails()">
	                  	...
	                  	<option value="{{ $driver->id }}" <?php if($driver->driverid == $sdriver->driverid){ echo "selected='selected'";}?>>{{ $driver->drivername }}</option>
	                  	@endforeach
                  	</select>
                ...
                <div class="form-group @if ($errors->has('driverphone')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" readonly id="inputDrivermobileno" placeholder="Driver Mobile no." name="driverphone" value="{{$sdriver->phone}}">
                ...
                <div class="form-group @if ($errors->has('driveraddress')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" readonly id="inputDriveraddress" placeholder="Driver Address" name="driveraddress" value="{{$sdriver->address}}">
