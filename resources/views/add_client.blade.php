            ...
            <!-- <form class="form-horizontal"> -->
              <div class="box-body">
                <div class="form-group @if ($errors->has('clientname')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputClientname" placeholder="Client Name" name="clientname" value="{{ Input::old('clientname') }}">
                ...
                <div class="form-group @if ($errors->has('clientphone')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputclientmobileno" placeholder="Client Mobile no." name="clientphone" value="{{ Input::old('clientphone') }}">
                ...
                <div class="form-group @if ($errors->has('clientemail')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputclientemail" placeholder="Client email" name="clientemail" value="{{ Input::old('clientemail') }}">
                ...
                <div class="form-group @if ($errors->has('clientaddress')) has-error @endif">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control" id="inputclientaddress" placeholder="Client Address" name="clientaddress" value="{{ Input::old('clientaddress') }}">
                    </textarea> 
